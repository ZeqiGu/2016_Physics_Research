...
t0=Time(1483315200, format='unix');
#1510259054   1508588104  1517236865  1500140729  1491240677 1483372706
x=get_sun(t);
sunx=x.ra.value;
suny=x.dec.value;
fig, ax = plt.subplots()
ax.add_patch(patches.Circle((sunx,suny),10, facecolor="red"))
#ax.add_patch(patches.CirclePolygon((149.2,0.2),10, 6,edgecolor="white",fill=False))
#day_03h_s
ax.add_patch(patches.Rectangle((30-105/2,-40.5-21/2),105, 21,edgecolor="white",fill=False))
ax.add_patch(patches.Rectangle((360-22.5,-40.5-21/2),22.5, 21,edgecolor="white",fill=False))
#day_12h_s
#ax.add_patch(patches.Rectangle((100+170-32/2,-20-20/2),32, 20,edgecolor="white",fill=False))
#day_12h_n
ax.add_patch(patches.Rectangle((210-55/2,11-16/2),55, 16,edgecolor="white",fill=False))
#wideAS
ax.add_patch(patches.Rectangle((12.5-185/2,-39.5-41/2),185, 41,edgecolor="white",fill=False))
ax.add_patch(patches.Rectangle((360-(185/2-12.5),-39.5-41/2),(185/2-12.5), 41,edgecolor="white",fill=False))
#wideAN
ax.add_patch(patches.Rectangle((12.5-145/2,-0.5-41/2),145, 41,edgecolor="white",fill=False))
ax.add_patch(patches.Rectangle((360-(145/2-12.5),-0.5-41/2),(145/2-12.5), 41,edgecolor="white",fill=False))
#wideB
ax.add_patch(patches.Rectangle((182.5-155/2,8-26/2),155, 26,edgecolor="white",fill=False))
plt.imshow(pix00,origin='lower',interpolation='gaussian', cmap=mpl.cm.get_cmap('jet'),extent=(0,360,-90,90))
plt.colorbar(ax=ax)
plt.show()    
